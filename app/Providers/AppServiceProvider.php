...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        $bindings = [
            ...
            \App\Contracts\Auth\OtpContract::class => \App\Services\Auth\OtpService::class,
            \App\Contracts\Admin\Modules\ModuleDefinitionContract::class => \App\Services\Admin\Modules\ModuleDefinition::class,
            \App\Contracts\Admin\Modules\ModuleQueryContract::class => \App\Services\Admin\Modules\ModuleQuery::class,
            \App\Contracts\Admin\Modules\ModuleValidationContract::class => \App\Services\Admin\Modules\ModuleValidation::class,
            \App\Contracts\Admin\Modules\ModuleFormDataContract::class => \App\Services\Admin\Modules\ModuleFormData::class,
            \App\Contracts\Admin\Modules\ModuleInputContract::class => \App\Services\Admin\Modules\ModuleInput::class,
            \App\Contracts\Admin\Modules\ModuleExportContract::class => \App\Services\Admin\Modules\ModuleExport::class,
            \App\Contracts\Admin\Imports\ImportRowReaderContract::class => \App\Services\Admin\Imports\ImportRowReader::class,
            \App\Contracts\Admin\Imports\ImportFileReaderContract::class => \App\Services\Admin\Imports\SpreadsheetImportReader::class,
            \App\Contracts\Admin\Imports\ImportImagePathContract::class => \App\Services\Admin\Imports\ImportImagePathNormalizer::class,
            \App\Contracts\Admin\Imports\ImportImageArchiveContract::class => \App\Services\Admin\Imports\ZipImportImageExtractor::class,
            \App\Contracts\Admin\Imports\ImportRowMapperContract::class => \App\Services\Admin\Imports\ImportRowMapper::class,
            \App\Contracts\Admin\Imports\ImportRelationResolverContract::class => \App\Services\Admin\Imports\ImportRelationResolver::class,
            \App\Contracts\Admin\Imports\ProductImportMastersContract::class => \App\Services\Admin\Imports\ProductImportMasters::class,
            \App\Contracts\Admin\Imports\ProductImportMediaContract::class => \App\Services\Admin\Imports\ProductImportMedia::class,
            \App\Contracts\Admin\Imports\ImportSampleContract::class => \App\Services\Admin\Imports\ImportSampleBuilder::class,
            \App\Contracts\Admin\Imports\ImportRunnerContract::class => \App\Services\Admin\Imports\ModuleImportRunner::class,
