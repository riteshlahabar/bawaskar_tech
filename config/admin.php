    ...
    'modules' => [
        ...
        'products'=>[
            ...
            'fields'=>[
                ...
                ['type'=>'section_heading','label'=>'Homepage Display Fields','visibility_field'=>'homepage_section_id','show_for_section_types'=>['hero_slider','top_small_banners','product_section','coupon_section','top_selling_section','offer_section','strip_offer_banner','service_section','blog_section']],
                ...
                ['name'=>'homepage_image_path','label'=>'Homepage Image / Banner Image','type'=>'image','upload_dir'=>'uploads/products/homepage','rules'=>['nullable','image','max:5120'],'help'=>'Hero: 1920x637, Product card: 500x500, Small banner: 375x243, Offer banner depends on layout.','visibility_field'=>'homepage_section_id','show_for_section_types'=>['hero_slider','top_small_banners','offer_section','blog_section']],
                ['name'=>'homepage_mobile_image_path','label'=>'Homepage Mobile Image','type'=>'image','upload_dir'=>'uploads/products/homepage/mobile','rules'=>['nullable','image','max:5120'],'visibility_field'=>'homepage_section_id','show_for_section_types'=>['hero_slider','top_small_banners','offer_section','blog_section']],
                ['name'=>'homepage_logo_image_path','label'=>'Homepage Logo Image / Coupon Logo','type'=>'image','upload_dir'=>'uploads/products/homepage/logos','rules'=>['nullable','image','max:2048'],'help'=>'Coupon logo recommended 290x90.','visibility_field'=>'homepage_section_id','show_for_section_types'=>['coupon_section']],
                ['name'=>'homepage_offer_image_path','label'=>'Homepage Offer Image','type'=>'image','upload_dir'=>'uploads/products/homepage/offers','rules'=>['nullable','image','max:5120'],'help'=>'Coupon offer image recommended 250x200.','visibility_field'=>'homepage_section_id','show_for_section_types'=>['coupon_section']],
