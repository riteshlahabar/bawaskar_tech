...
return [
    ...
    'modules' => [
        ...
        'orders' => [
            'label' => 'Sale Orders', 'group' => 'Sales', 'channel' => ['column' => 'order_type'], 'singular' => 'Sale Order', 'model' => Order::class, 'with' => ['customer', 'dealer.dealerProfile', 'salesman', 'invoice', 'proformaInvoices'], 'search' => ['order_no'], 'status_column' => 'status', 'status_options' => $orderStatus, 'filters' => [['name' => 'type', 'column' => 'order_type']], 'can_delete' => false, 'form_layout' => 'tabs',
            ...
            'fields' => [
                ['type' => 'section_heading', 'label' => '1. Order Info'],
                ['name' => 'order_type', 'label' => 'Channel', 'type' => 'select', 'query_key' => 'type', 'options' => ['customer' => 'Customer', 'dealer' => 'Dealer'], 'rules' => ['required', 'in:customer,dealer']], ['name' => 'order_no', 'label' => 'Sale Order Number', 'rules' => ['nullable', 'string', 'max:80', 'unique:orders,order_no,{id}'], 'help' => 'Leave blank to auto-generate.'], ['name' => 'customer_id', 'label' => 'Customer', 'type' => 'select', 'option_model' => User::class, 'option_where' => ['role' => 'customer'], 'rules' => ['nullable', 'required_if:order_type,customer', 'exists:users,id']], ['name' => 'dealer_id', 'label' => 'Dealer', 'type' => 'select', 'option_model' => User::class, 'option_where' => ['role' => 'dealer'], 'rules' => ['nullable', 'required_if:order_type,dealer', 'exists:users,id']], ['name' => 'salesman_id', 'label' => 'Salesman', 'type' => 'select', 'option_model' => User::class, 'option_where' => ['role' => 'salesman'], 'rules' => ['nullable', 'exists:users,id']],
                ['type' => 'section_heading', 'label' => '2. Amounts'],
                ['name' => 'subtotal', 'label' => 'Subtotal', 'type' => 'number', 'step' => '0.01', 'rules' => ['nullable', 'numeric', 'min:0']], ['name' => 'gst_total', 'label' => 'GST Total', 'type' => 'number', 'step' => '0.01', 'rules' => ['nullable', 'numeric', 'min:0']], ['name' => 'discount_total', 'label' => 'Discount', 'type' => 'number', 'step' => '0.01', 'rules' => ['nullable', 'numeric', 'min:0']], ['name' => 'grand_total', 'label' => 'Grand Total', 'type' => 'number', 'step' => '0.01', 'rules' => ['nullable', 'numeric', 'min:0'], 'help' => 'Leave blank to calculate from subtotal + GST - discount.'],
                ['type' => 'section_heading', 'label' => '3. Notes'],
                ['name' => 'notes', 'label' => 'Notes', 'type' => 'textarea', 'col' => 'col-12', 'rules' => ['nullable', 'string']],
            ],
        ],
        'proforma-invoices' => [
            'label' => 'Proforma Invoices', 'group' => 'Sales', 'channel' => ['relation' => 'order', 'column' => 'order_type'], 'singular' => 'Proforma Invoice', 'description' => 'Quotation-style invoice generated before sale invoice and dispatch.', 'model' => ProformaInvoice::class, 'with' => ['order.customer', 'order.dealer.dealerProfile', 'order.salesman'], 'search' => ['proforma_no'], 'status_column' => 'status', 'status_options' => ['draft' => 'Draft', 'sent' => 'Sent', 'accepted' => 'Accepted', 'converted' => 'Converted', 'cancelled' => 'Cancelled'], 'filters' => [['name' => 'type', 'relation' => 'order', 'column' => 'order_type']], 'form_layout' => 'tabs',
        ...
        'invoices' => [
            ...
            'fields' => [
                ['type' => 'section_heading', 'label' => '1. Document Info'],
                ['name' => 'order_id', 'label' => 'Sale Order', 'type' => 'select', 'option_model' => Order::class, 'option_label' => 'order_no', 'rules' => ['required', 'exists:orders,id', 'unique:invoices,order_id,{id}']], ['name' => 'invoice_no', 'label' => 'Invoice Number', 'rules' => ['nullable', 'string', 'max:80', 'unique:invoices,invoice_no,{id}'], 'help' => 'Leave blank to auto-generate.'], ['name' => 'invoice_date', 'label' => 'Invoice Date', 'type' => 'date', 'rules' => ['nullable', 'date'], 'help' => 'Leave blank to use today.'],
                ['type' => 'section_heading', 'label' => '2. Amount & File'],
                ['name' => 'grand_total', 'label' => 'Grand Total', 'type' => 'number', 'step' => '0.01', 'rules' => ['nullable', 'numeric', 'min:0'], 'help' => 'Leave blank to copy from sale order.'], ['name' => 'pdf_path', 'label' => 'PDF Path', 'rules' => ['nullable', 'string', 'max:255']],
            ],
        ],
        'dispatches' => [
            'label' => 'Dispatch & Delivery', 'group' => 'Sales', 'channel' => ['relation' => 'order', 'column' => 'order_type'], 'singular' => 'Dispatch', 'model' => Dispatch::class, 'with' => ['order.invoice'], 'search' => ['dispatch_no', 'courier_name', 'tracking_no'], 'status_column' => 'status', 'status_options' => ['packing' => 'Packing', 'dispatched' => 'Dispatched', 'out_for_delivery' => 'Out for Delivery', 'delivered' => 'Delivered', 'returned' => 'Returned'], 'filters' => [['name' => 'type', 'relation' => 'order', 'column' => 'order_type']],
            'columns' => [['key' => 'dispatch_no', 'label' => 'Dispatch No.'], ['key' => 'order.invoice.invoice_no', 'label' => 'Sale Invoice'], ['key' => 'courier_name', 'label' => 'Courier'], ['key' => 'tracking_no', 'label' => 'Tracking'], ['key' => 'status', 'label' => 'Status', 'type' => 'status'], ['key' => 'delivered_at', 'label' => 'Delivered', 'type' => 'datetime']],
            'fields' => [['name' => 'order_id', 'label' => 'Sale Invoice', 'type' => 'select', 'option_model' => Invoice::class, 'option_label' => 'invoice_no', 'option_value' => 'order_id', 'rules' => ['required', 'exists:orders,id'], 'create_only' => true], ['name' => 'dispatch_no', 'label' => 'Dispatch Number', 'rules' => ['nullable', 'string', 'max:80', 'unique:dispatches,dispatch_no,{id}'], 'help' => 'Leave blank to auto-generate.', 'create_only' => true], ['name' => 'status', 'label' => 'Status', 'type' => 'select', 'options' => ['packing' => 'Packing', 'dispatched' => 'Dispatched', 'out_for_delivery' => 'Out for Delivery', 'delivered' => 'Delivered', 'returned' => 'Returned'], 'rules' => ['required', 'string', 'max:40']], ['name' => 'packing_at', 'label' => 'Packing At', 'type' => 'datetime-local', 'rules' => ['nullable', 'date'], 'edit_only' => true], ['name' => 'courier_name', 'label' => 'Courier Name', 'rules' => ['nullable', 'string', 'max:255']], ['name' => 'tracking_no', 'label' => 'Tracking Number', 'rules' => ['nullable', 'string', 'max:255']], ['name' => 'tracking_url', 'label' => 'Tracking URL', 'type' => 'url', 'rules' => ['nullable', 'url', 'max:255']], ['name' => 'delivered_at', 'label' => 'Delivered At', 'type' => 'datetime-local', 'rules' => ['nullable', 'date']]],
        ],
        'returns' => [
        ...
        'outstanding' => [
            ...
            'fields' => [['name' => 'credit_limit', 'label' => 'Credit Limit', 'type' => 'number', 'step' => '0.01', 'rules' => ['required', 'numeric', 'min:0']]],
        ],
        'expense-categories' => [
        ...
        'attendance' => [
            ...
            'columns' => [['key' => 'salesman.name', 'label' => 'Salesman'], ['key' => 'attendance_date', 'label' => 'Date', 'type' => 'date'], ['key' => 'check_in_at', 'label' => 'Check In', 'type' => 'datetime'], ['key' => 'check_out_at', 'label' => 'Check Out', 'type' => 'datetime'], ['key' => 'working_minutes', 'label' => 'Minutes'], ['key' => 'break_minutes', 'label' => 'Break (min)'], ['key' => 'status', 'label' => 'Status', 'type' => 'status']],
        ...
        'tour-plans' => [
            ...
            'columns' => [['key' => 'salesman.name', 'label' => 'Salesman'], ['key' => 'plan_date', 'label' => 'Date', 'type' => 'date'], ['key' => 'route_name', 'label' => 'Route'], ['key' => 'dealer_stops', 'label' => 'Dealers'], ['key' => 'status', 'label' => 'Status', 'type' => 'status']],
            'fields' => [['name' => 'salesman_id', 'label' => 'Salesman', 'type' => 'select', 'option_model' => User::class, 'option_where' => ['role' => 'salesman'], 'rules' => ['required', 'exists:users,id']], ['name' => 'plan_date', 'label' => 'Plan Date', 'type' => 'date', 'rules' => ['required', 'date']], ['name' => 'route_name', 'label' => 'Route Name', 'rules' => ['required', 'string', 'max:255']], ['name' => 'dealer_ids', 'label' => 'Dealers On This Route', 'type' => 'checkbox_list', 'option_model' => User::class, 'option_where' => ['role' => 'dealer'], 'clearable' => true, 'help' => 'Tick every dealer the salesman should visit on this route.', 'rules' => ['nullable', 'array']], ['name' => 'status', 'label' => 'Status', 'type' => 'select', 'options' => ['planned' => 'Planned', 'approved' => 'Approved', 'completed' => 'Completed', 'cancelled' => 'Cancelled'], 'rules' => ['required', 'string', 'max:40']]],
        ],
        'expenses' => [
        ...
        'assets' => [
            ...
            'columns' => [['key' => 'salesman.name', 'label' => 'Salesman'], ['key' => 'asset_type', 'label' => 'Type'], ['key' => 'asset_name', 'label' => 'Asset'], ['key' => 'serial_no', 'label' => 'Serial No.'], ['key' => 'issued_on', 'label' => 'Issued', 'type' => 'date'], ['key' => 'return_requested_at', 'label' => 'Return Requested', 'type' => 'date'], ['key' => 'status', 'label' => 'Status', 'type' => 'status']],
            'fields' => [['name' => 'salesman_id', 'label' => 'Salesman', 'type' => 'select', 'option_model' => User::class, 'option_where' => ['role' => 'salesman'], 'rules' => ['required', 'exists:users,id']], ['name' => 'asset_type', 'label' => 'Asset Type', 'type' => 'select', 'options' => ['mobile' => 'Mobile', 'laptop' => 'Laptop', 'sim' => 'SIM Card', 'vehicle' => 'Vehicle', 'other' => 'Other'], 'rules' => ['required', 'string', 'max:40']], ['name' => 'asset_name', 'label' => 'Asset Name', 'rules' => ['required', 'string', 'max:255']], ['name' => 'serial_no', 'label' => 'Serial Number', 'rules' => ['nullable', 'string', 'max:255']], ['name' => 'issued_on', 'label' => 'Issued On', 'type' => 'date', 'rules' => ['nullable', 'date']], ['name' => 'returned_on', 'label' => 'Returned On', 'type' => 'date', 'rules' => ['nullable', 'date']], ['name' => 'condition', 'label' => 'Condition', 'rules' => ['nullable', 'string', 'max:255']], ['name' => 'salesman_remarks', 'label' => 'Salesman Remarks', 'type' => 'textarea', 'rows' => 3, 'help' => 'Written by the salesman from the app when they report an issue or request a return.', 'rules' => ['nullable', 'string', 'max:2000']], ['name' => 'status', 'label' => 'Status', 'type' => 'select', 'options' => ['issued' => 'Issued', 'returned' => 'Returned', 'lost' => 'Lost', 'damaged' => 'Damaged'], 'rules' => ['required', 'string', 'max:40']]],
        ],
        'resignations' => [
