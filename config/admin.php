...
return [
    ...
    'modules' => [
        'salesmen' => [
            'label' => 'Salesmen', 'group' => 'People', 'where' => ['role' => User::ROLE_SALESMAN], 'description' => 'Company field-sales employees with email and password login.', 'model' => User::class, 'with' => ['salesmanProfile'], 'search' => ['name', 'email', 'mobile'], 'status_column' => 'status', 'status_options' => $userStatus,
        ...
        'dealers' => [
            'label' => 'Dealers', 'group' => 'People', 'where' => ['role' => User::ROLE_DEALER], 'description' => 'B2B dealer registration, approval, salesman assignment, credit and outstanding.', 'model' => User::class, 'with' => ['dealerProfile.salesman'], 'search' => ['name', 'email', 'mobile'], 'status_column' => 'status', 'status_options' => $userStatus,
        ...
        'customers' => [
            'label' => 'Customers', 'group' => 'People', 'where' => ['role' => User::ROLE_CUSTOMER], 'description' => 'B2C retail customer accounts and language preferences.', 'model' => User::class, 'with' => ['customerProfile'], 'search' => ['name', 'email', 'mobile'], 'status_column' => 'status', 'status_options' => $userStatus,
        ...
        'languages' => [
            'label' => 'Languages', 'group' => 'Settings', 'singular' => 'Language', 'model' => Language::class, 'search' => ['code', 'name', 'native_name'], 'status_column' => 'is_active', 'status_options' => $active, 'can_delete' => false,
            ...
            'label' => 'App Translations', 'group' => 'Settings', 'singular' => 'Translation', 'description' => 'Customer, dealer and salesman app text. The apps register their English text automatically; press Translate to fill every language, then correct any wrong wording here.', 'model' => AppTranslation::class, 'search' => ['translation_key', 'english_text', 'value', 'locale'], 'status_column' => 'is_active', 'status_options' => $active, 'sort' => ['id', 'desc'],
            'filters' => [
