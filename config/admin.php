    ...
    'modules' => [
        ...
        'categories'=>[
            ...
            'fields'=>[
                ...
                ['name'=>'image_path','label'=>'Category Image - 130 x 130 px','type'=>'image','upload_dir'=>'uploads/categories','rules'=>['nullable','image','max:2048']],
        ...
        'products'=>[
            ...
            'fields'=>[
                ...
                ['name'=>'homepage_section_id','label'=>'Homepage Section Title','type'=>'select','option_model'=>ProductHomepageSection::class,'option_where'=>['is_active'=>true],'option_label'=>'title','rules'=>['nullable','exists:product_homepage_sections,id'],'help'=>'Select any Homepage Settings section. Product will display according to selected section type.'],
                ['type'=>'section_heading','label'=>'Homepage Display Fields'],
                ['name'=>'homepage_title','label'=>'Homepage Title','rules'=>['nullable','string','max:255']],
                ['name'=>'homepage_subtitle','label'=>'Homepage Subtitle','rules'=>['nullable','string','max:255']],
                ['name'=>'homepage_description','label'=>'Homepage Description','type'=>'textarea','col'=>'col-12','rows'=>3,'rules'=>['nullable','string']],
                ['name'=>'homepage_image_path','label'=>'Homepage Image / Banner Image','type'=>'image','upload_dir'=>'uploads/products/homepage','rules'=>['nullable','image','max:5120'],'help'=>'Hero: 1920x637, Product card: 500x500, Small banner: 375x243, Offer banner depends on layout.'],
                ['name'=>'homepage_mobile_image_path','label'=>'Homepage Mobile Image','type'=>'image','upload_dir'=>'uploads/products/homepage/mobile','rules'=>['nullable','image','max:5120']],
                ['name'=>'homepage_logo_image_path','label'=>'Homepage Logo Image / Coupon Logo','type'=>'image','upload_dir'=>'uploads/products/homepage/logos','rules'=>['nullable','image','max:2048'],'help'=>'Coupon logo recommended 290x90.'],
                ['name'=>'homepage_offer_image_path','label'=>'Homepage Offer Image','type'=>'image','upload_dir'=>'uploads/products/homepage/offers','rules'=>['nullable','image','max:5120'],'help'=>'Coupon offer image recommended 250x200.'],
                ['name'=>'homepage_highlight_text','label'=>'Homepage Highlight Text','rules'=>['nullable','string','max:255']],
                ['name'=>'homepage_discount_text','label'=>'Homepage Discount Text','rules'=>['nullable','string','max:255']],
                ['name'=>'homepage_validity_text','label'=>'Homepage Validity Text','rules'=>['nullable','string','max:255']],
                ['name'=>'homepage_coupon_code','label'=>'Homepage Coupon Code','rules'=>['nullable','string','max:80']],
                ['name'=>'homepage_button_text','label'=>'Homepage Button Text','rules'=>['nullable','string','max:120']],
                ['name'=>'homepage_button_url','label'=>'Homepage Button Link','rules'=>['nullable','string','max:255']],
                ['name'=>'homepage_icon_key','label'=>'Homepage Service Icon / SVG Key','rules'=>['nullable','string','max:120']],
                ['name'=>'homepage_slot','label'=>'Homepage Slot / Position','rules'=>['nullable','string','max:80'],'help'=>'Example: big, small, left, right, first, second.'],
                ['name'=>'homepage_background_color','label'=>'Homepage Background Color','rules'=>['nullable','string','max:30']],
                ['name'=>'homepage_text_color','label'=>'Homepage Text Color','rules'=>['nullable','string','max:30']],
                ['name'=>'homepage_sort_order','label'=>'Homepage Product Sort Order','type'=>'number','default'=>0,'rules'=>['nullable','integer','min:0']],
                ...
                ['type'=>'section_heading','label'=>'4. Product Detail Tabs'],
                ...
                ['type'=>'section_heading','label'=>'5. Detail Page Banners'],
                ...
                ['type'=>'section_heading','label'=>'6. Seller / Manufacturer Info'],
                ...
                ['type'=>'section_heading','label'=>'7. Deal Timer / Stock Display'],
                ...
                ['name'=>'show_on_homepage','label'=>'Allow product on homepage product rows','type'=>'checkbox','rules'=>['boolean']],
                ['name'=>'is_featured','label'=>'Featured Product','type'=>'checkbox','rules'=>['boolean']],
                ...
                ['name'=>'is_offer_product','label'=>'Offer Product','type'=>'checkbox','rules'=>['boolean']],
                ['name'=>'is_deal_timer_product','label'=>'Deal Timer Product','type'=>'checkbox','rules'=>['boolean']],
                ['name'=>'sort_order','label'=>'Product Sort Order','type'=>'number','default'=>0,'rules'=>['nullable','integer','min:0']],
        ...
        'homepage-setting-items'=>[
            ...
            'model'=>\App\Models\Catalog\ProductHomepageSectionItem::class,
            'with'=>['section'],
            ...
            'fields'=>[
                ['name'=>'section_id','label'=>'Homepage Section','type'=>'select','option_model'=>\App\Models\Catalog\ProductHomepageSection::class,'option_label'=>'title','rules'=>['required','exists:product_homepage_sections,id']],
