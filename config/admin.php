...
return [
    ...
    'modules' => [
        ...
        'dispatches' => [
            ...
            'fields' => [['name' => 'order_id', 'label' => 'Sale Invoice', 'type' => 'select', 'option_model' => Invoice::class, 'option_label' => 'invoice_no', 'option_value' => 'order_id', 'rules' => ['required', 'exists:orders,id'], 'create_only' => true], ['name' => 'dispatch_no', 'label' => 'Dispatch Number', 'rules' => ['nullable', 'string', 'max:80', 'unique:dispatches,dispatch_no,{id}'], 'help' => 'Leave blank to auto-generate.', 'create_only' => true], ['name' => 'status', 'label' => 'Status', 'type' => 'select', 'options' => ['packing' => 'Packing', 'dispatched' => 'Dispatched', 'in_transit' => 'In Transit', 'out_for_delivery' => 'Out for Delivery', 'delivered' => 'Delivered', 'returned' => 'Returned'], 'rules' => ['required', 'string', 'max:40']], ['name' => 'packing_at', 'label' => 'Packing At', 'type' => 'datetime-local', 'rules' => ['nullable', 'date'], 'edit_only' => true], ['name' => 'courier_name', 'label' => 'Courier Name', 'rules' => ['nullable', 'string', 'max:255']], ['name' => 'tracking_no', 'label' => 'Tracking Number', 'rules' => ['nullable', 'string', 'max:255']], ['name' => 'tracking_url', 'label' => 'Tracking URL', 'type' => 'url', 'rules' => ['nullable', 'url', 'max:255']], ['name' => 'delivered_at', 'label' => 'Delivered At', 'type' => 'datetime-local', 'rules' => ['nullable', 'date']]],
        ],
        'returns' => [
