    ...
    'modules' => [
        ...
        'products' => [
            ...
            'fields' => [
                ...
                ['name' => 'description', 'label' => 'Description', 'type' => 'textarea', 'col' => 'col-md-6', 'rows' => 10, 'rules' => ['nullable', 'string'], 'render_inside' => 'product_bottom_details', 'render_group' => 'description'],
                ['name' => 'benefits', 'label' => 'Benefits', 'type' => 'textarea', 'col' => 'col-md-6', 'rows' => 10, 'rules' => ['nullable', 'string'], 'render_inside' => 'product_bottom_details', 'render_group' => 'description'],
                ['name' => 'usage_instructions', 'label' => 'Usage Instructions', 'type' => 'textarea', 'col' => 'col-md-6', 'rows' => 10, 'rules' => ['nullable', 'string'], 'render_inside' => 'product_bottom_details', 'render_group' => 'description'],
                ['name' => 'crop_information', 'label' => 'Crop Information', 'type' => 'textarea', 'col' => 'col-md-6', 'rows' => 10, 'rules' => ['nullable', 'string'], 'render_inside' => 'product_bottom_details', 'render_group' => 'description'],
