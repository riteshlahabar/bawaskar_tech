...
return [
    ...
    'modules' => [
        ...
        'languages' => [
            ...
            'label' => 'App Translations', 'group' => 'System', 'singular' => 'Translation', 'description' => 'Customer, dealer and salesman app text. The apps register their English text automatically; press Translate to fill every language, then correct any wrong wording here.', 'model' => AppTranslation::class, 'search' => ['translation_key', 'english_text', 'value', 'locale'], 'status_column' => 'is_active', 'status_options' => $active, 'sort' => ['id', 'desc'],
            'filters' => [
