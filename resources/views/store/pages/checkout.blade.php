                    ...
                    <div class="right-side-summery-box">
                        <div class="summery-box-2">
                            ...
                            <ul class="summery-contain">
                                ...
                                <li>
                                    <img src="{{ asset('fastkart-store/images/vegetable/product/5.png') }}"
                                        class="img-fluid blur-up lazyloaded checkout-image" alt="">
                                ...
                                <li>
                                    <img src="{{ asset('fastkart-store/images/vegetable/product/6.png') }}"
                                        class="img-fluid blur-up lazyloaded checkout-image" alt="">
                        ...
                        <div class="checkout-offer">
                            <div class="offer-title">
                                <div class="offer-icon">
                                    <img src="{{ asset('fastkart-store/images/inner-page/offer.svg') }}" class="img-fluid" alt="">
                                </div>
