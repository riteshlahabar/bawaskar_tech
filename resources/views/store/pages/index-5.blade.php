        ...
        <div class="container-fluid-lg">
            ...
            @if($personalCareBanners->isNotEmpty())
                <div class="row gy-lg-0 gy-3">
                    @foreach($personalCareBanners as $personalCareBanner)
                        @php
                            $personalCareUrl = data_get($personalCareBanner, 'button_url') ?: route('store.page', ['page' => 'shop-left-sidebar']);
                        @endphp

                        <div class="{{ $personalCareBanners->count() > 1 ? 'col-lg-6' : 'col-12' }}">
                            <a href="{{ $personalCareUrl }}" class="d-block">
                                <img
