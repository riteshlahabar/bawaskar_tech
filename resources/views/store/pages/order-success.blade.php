                                ...
                                <tbody>
                                        ...
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Bell pepper</a>
                                                        </li>
                                        ...
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Eggplant</a>
                                                        </li>
                                    ...
                                    <tr>
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                <a href="product.left-sidebar.html" class="product-image">
                                                    <img src="{{ asset('fastkart-store/images/vegetable/product/3.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Onion</a>
                                                        </li>
                                ...
                                <ul class="summery-contain pb-0 border-bottom-0">
                                    ...
                                    <li class="pb-0">
                                        ...
                                        <h4 class="price theme-color">
                                            <a href="{{ route('store.page', ['page'=>'order-tracking']) }}" class="text-danger">Track Order</a>
                                        </h4>
                                    </li>
                                </ul>
