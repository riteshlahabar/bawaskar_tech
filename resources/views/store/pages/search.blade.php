            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-contain">
                        <h2>{{ web_t('header.search', 'Search') }}</h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">{{ web_t('header.search', 'Search') }}</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-8 mx-auto">
                    <div class="title d-block text-center">
                        <h2>{{ web_t('header.search_placeholder', 'Search for products') }}</h2>
                    ...
                    <div class="search-box">
                        <form action="{{ route('store.page', ['page' => 'search']) }}" method="GET" role="search">
                            <div class="input-group">
                                <input type="text" name="search" value="{{ $searchQuery ?? '' }}" class="form-control" placeholder="{{ web_t('header.search_placeholder', 'Search for products') }}">
                                <button class="btn theme-bg-color text-white m-0" type="submit"
                                    id="button-addon1">{{ web_t('header.search', 'Search') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="search-product product-wrapper">
                        ...
                        @empty
                            <div class="w-100">
                                <div class="alert alert-light mb-0">{{ web_t('search.no_results', 'No products found.') }}</div>
                            </div>
                        @endforelse
                    </div>
                </div>
