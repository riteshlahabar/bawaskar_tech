                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel">
                                    <div class="dashboard-home">
                                        ...
                                        <div class="total-box"><div class="row g-sm-4 g-3"><div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6"><div class="total-contain"><img src="{{ asset('fastkart-store/images/svg/order.svg') }}" class="img-1 blur-up lazyload" alt=""><img src="{{ asset('fastkart-store/images/svg/order.svg') }}" class="blur-up lazyload" alt=""><div class="total-detail"><h5>{{ web_t('dashboard.total_order', 'Total Order') }}</h5><h3>{{ $orderCount }}</h3></div></div></div><div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6"><div class="total-contain"><img src="{{ asset('fastkart-store/images/svg/pending.svg') }}" class="img-1 blur-up lazyload" alt=""><img src="{{ asset('fastkart-store/images/svg/pending.svg') }}" class="blur-up lazyload" alt=""><div class="total-detail"><h5>{{ web_t('dashboard.total_pending_order', 'Total Pending Order') }}</h5><h3>{{ $pendingOrderCount }}</h3></div></div></div><div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6"><div class="total-contain"><img src="{{ asset('fastkart-store/images/svg/wishlist.svg') }}" class="img-1 blur-up lazyload" alt=""><img src="{{ asset('fastkart-store/images/svg/wishlist.svg') }}" class="blur-up lazyload" alt=""><div class="total-detail"><h5>{{ web_t('dashboard.saved_address', 'Saved Address') }}</h5><h3>{{ $addressCount }}</h3></div></div></div></div></div>
    ...
    <footer class="section-t-space">
        <div class="container-fluid-lg">
            ...
            <div class="sub-footer section-small-space">
                <div class="reserve">
                    <h6 class="text-content">ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã‚Â¡ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â©2022 Bawaskar Farmer Store All rights reserved</h6>
                </div>
