                            ...
                            <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky">
                                <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                                                                        <li class="nav-item">
                                                <a class="nav-link" href="{{ route('store.home') }}">Home</a>
                                            </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    Thumbnail</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Images</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Slider</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Sticky</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Accordion</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Tab</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Digital</a>

                                                                <h5 class="custom-mt dropdown-header">Product Features
                                                                </h5>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Bundle (Cross Sale)</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Hot Stock
                                                                    Progress <label class="menu-label">New</label>
                                                                </a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">SOLD OUT</a>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Variant Circle <label
                                                                        class="menu-label">New</label></a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Variant Image
                                                                    Swatch</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Variant Color</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Variant Radio Button</a>
                                                                <a class="dropdown-item"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    Checkout</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Dynamic Checkout</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Secure Checkout</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Active Product view</a>
                                                                <a class="dropdown-item" href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">
                                                                    Active
                                                                    Last Orders
                                                                </a>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                <h5 class="dropdown-header">
                                                                    Product Features </h5>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Product Simple</a>
                                                                <a class="dropdown-item" href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">
                                                                    Product Classified <label
                                                                        class="menu-label">New</label>
                                                                </a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Size Chart <label
                                                                        class="menu-label">New</label></a>
                                                                <a class="dropdown-item"
                                                                ...
                                                                <a class="dropdown-item" href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Store
                                                                    Information</a>
                                                                <a class="dropdown-item"
                                                                    href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">Social Share <label
                                                ...
                                                <div class="dropdown-menu dropdown-menu-2">
                                                    <div class="row">
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Broccoli & Cauliflower</a>

                                                            <a href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}"
                                                                class="dropdown-item">Chilies, Garlic</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Vegetables & Salads</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Gourd, Cucumber</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Chilies, Garlic</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Potatoes & Tomatoes</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Asparagus & Artichokes</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Avocados & Peppers</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Broccoli & Zucchini</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Celery, Fennel & Leeks</a>

                                                            <a class="dropdown-item"
                                                                href="{{ route('store.page', ['page'=>'shop-left-sidebar']) }}">Chilies & Lime</a>
                                                        </div>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('store.home') }}">Seller Grid
                                                            2</a>
                                                    </li>
                                                </ul>
                                            </li>
                    ...
                    <div class="dashboard-left-sidebar">
                        ...
                        <div class="profile-box">
                            <div class="cover-image">
                                <img src="{{ asset('fastkart-store/images/inner-page/cover-img.jpg') }}" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        <img src="{{ asset('fastkart-store/images/inner-page/user/1.jpg') }}"
                                        ...
                                        <div class="row g-sm-4 g-3">
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="total-contain">
                                                    <img src="{{ asset('fastkart-store/images/svg/order.svg') }}"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('fastkart-store/images/svg/order.svg') }}" class="blur-up lazyload"
                                                        alt="">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="total-contain">
                                                    <img src="{{ asset('fastkart-store/images/svg/pending.svg') }}"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('fastkart-store/images/svg/pending.svg') }}" class="blur-up lazyload"
                                                        alt="">
                                                    <div class="total-detail">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="total-contain">
                                                    <img src="{{ asset('fastkart-store/images/svg/wishlist.svg') }}"
                                                        class="img-1 blur-up lazyload" alt="">
                                                    <img src="{{ asset('fastkart-store/images/svg/wishlist.svg') }}"
                                                        class="blur-up lazyload" alt="">
                                                    <div class="total-detail">
                                        ...
                                        <div class="col-xxl-3 col-lg-6 col-md-4 col-sm-6">
                                            <div class="product-box-3 theme-bg-white h-100">
                                                <div class="product-header">
                                                    <div class="product-image">
                                                        <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}">
                                                            <img src="{{ asset('fastkart-store/images/cake/product/7.png') }}"
                                                                class="img-fluid blur-up lazyload" alt="">
                                                        </a>
                                    ...
                                    <div class="order-contain">
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}" class="order-image">
                                                    <img src="{{ asset('fastkart-store/images/vegetable/product/1.png') }}"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}" class="order-image">
                                                    <img src="{{ asset('fastkart-store/images/vegetable/product/2.png') }}" alt=""
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}" class="order-image">
                                                    <img src="{{ asset('fastkart-store/images/vegetable/product/3.png') }}" alt=""
                                                        class="blur-up lazyload">
                                                </a>
                                        ...
                                        <div class="order-box dashboard-bg-box">
                                            ...
                                            <div class="product-order-detail">
                                                <a href="{{ route('store.page', ['page'=>'product-left-thumbnail']) }}" class="order-image">
                                                    <img src="{{ asset('fastkart-store/images/vegetable/product/4.png') }}"
                                                        class="blur-up lazyload" alt="">
                                                </a>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{ asset('fastkart-store/images/payment-icon/1.jpg') }}"
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details card-visa">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{ asset('fastkart-store/images/payment-icon/2.jpg') }}"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="payment-card-detail">
                                                <div class="card-details debit-card">
                                                    ...
                                                    <div class="name-detail">
                                                        ...
                                                        <div class="card-img">
                                                            <img src="{{ asset('fastkart-store/images/payment-icon/3.jpg') }}"
                                                                class="img-fluid blur-up lazyloaded" alt="">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="dashboard-profile">
                                    ...
                                    <div class="profile-about dashboard-bg-box">
                                        <div class="row">
                                            ...
                                            <div class="col-xxl-5">
                                                <div class="profile-image">
                                                    <img src="{{ asset('fastkart-store/images/inner-page/dashboard-profile.png') }}"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>1</td>
                                                                    <td>
                                                                        <img src="{{ asset('fastkart-store/images/theme-icon/1.png') }}"
                                                                            class="img-fluid" alt="">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td>
                                                                        <img src="{{ asset('fastkart-store/images/theme-icon/2.png') }}"
                                                                            class="img-fluid" alt="">
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>3</td>
                                                                    <td>
                                                                        <img src="{{ asset('fastkart-store/images/theme-icon/3.png') }}"
                                                                            class="img-fluid" alt="">
                                                                    </td>
