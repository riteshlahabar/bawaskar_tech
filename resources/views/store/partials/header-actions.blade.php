    ...
    <li class="right-side">
        <div class="onhover-dropdown header-badge">
            <button type="button" class="btn p-0 position-relative header-wishlist">
                ...
                <span class="position-absolute top-0 start-100 translate-middle badge">{{ $headerCartCount }}
            ...
            <div class="onhover-div">
                ...
                <div class="price-box">
                    <h5>Total :</h5>
                    <h4 class="theme-color fw-bold">Rs. {{ number_format($headerCartTotal, 2) }}</h4>
                </div>

                <div class="button-group">
                    <a href="{{ route('store.page', ['page' => 'cart']) }}" class="btn btn-sm cart-button">View Cart</a>
                    <a href="{{ route('store.page', ['page' => 'checkout']) }}" class="btn btn-sm cart-button theme-bg-color text-white">Checkout</a>
                </div>
            </div>
        </div>
    </li>
