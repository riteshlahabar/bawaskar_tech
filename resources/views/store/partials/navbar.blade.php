...
<ul class="navbar-nav">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="{{ $storeUser ? route('store.page', ['page' => 'user-dashboard']) : route('store.page', ['page' => 'login']) }}" data-bs-toggle="dropdown">{{ $storeUser ? 'My Account' : web_t('nav.customer', 'Customer') }}</a>
        <ul class="dropdown-menu">
            @if($storeUser)
                <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'user-dashboard']) }}">{{ web_t('nav.dashboard', 'Dashboard') }}</a></li>
                <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'user-dashboard']) }}#pills-order">{{ web_t('nav.recent_order', 'Recent Order') }}</a></li>
                <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'order-tracking']) }}">{{ web_t('nav.order_tracking', 'Order Tracking') }}</a></li>
            @else
                <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'login']) }}">{{ web_t('nav.customer_login', 'Customer Login') }}</a></li>
                <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'sign-up']) }}">{{ web_t('nav.customer_register', 'Customer Register') }}</a></li>
                <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'order-tracking']) }}">{{ web_t('nav.order_tracking', 'Order Tracking') }}</a></li>
            @endif
        </ul>
    </li>
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="{{ route('store.page', ['page' => 'contact-us']) }}">{{ web_t('nav.contact_us', 'Contact Us') }}</a></li>
        </ul>
    </li>
</ul>
