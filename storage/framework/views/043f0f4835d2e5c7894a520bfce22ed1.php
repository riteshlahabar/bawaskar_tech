...
<head>
    ...
    <title>Admin Login | <?php echo e(config('admin.brand.name')); ?></title>
    <link rel="icon" href="<?php echo e(asset('fastkart-admin/images/favicon.png')); ?>">
...
<body>
    <section class="log-in-section section-b-space"><a href="<?php echo e(route('store.home')); ?>" class="logo-login"><span
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        ...
                        <div class="alert alert-success"><?php echo e(session('success')); ?></div><?php endif; ?> <?php if($errors->any()): ?>
                        <div class="alert alert-danger"><?php echo e($errors->first()); ?></div><?php endif; ?>
                        <div class="input-box">
                            <form class="row g-4" method="POST" action="<?php echo e(route('admin.login.store')); ?>"><?php echo csrf_field(); ?><div
                                    class="col-12">
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\admin\auth\login.blade.php ENDPATH**/ ?>