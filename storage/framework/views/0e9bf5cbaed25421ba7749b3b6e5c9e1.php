...
<div class="card">
    <div class="card-body pt-3">
        <div class="d-flex justify-content-end gap-2 mb-3 flex-wrap">
            <a href="<?php echo e(route($module['route'].'.index')); ?>" class="btn btn-outline-secondary">Back</a>
            <?php if($module['can_edit'] ?? true): ?>
                <a href="<?php echo e(route($module['route'].'.edit', $record->getKey())); ?>" class="btn btn-primary">Edit</a>
            <?php endif; ?>
