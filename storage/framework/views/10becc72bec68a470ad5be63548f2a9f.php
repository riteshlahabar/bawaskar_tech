    ...
    <div class="card-body pt-3">
        <div class="d-flex justify-content-end gap-2 mb-3">
            ...
            <?php if($module['can_create'] ?? true): ?>
                <a href="<?php echo e(route($module['route'].'.create', request()->only(['type','placement','section_key','row_title']))); ?>" class="btn btn-primary"><i class="iconoir-plus-circle me-1"></i>Add <?php echo e($submenuSingular); ?></a>
            <?php endif; ?>
        </div>
                                ...
                                <td class="text-end">
                                    <div class="dropdown admin-row-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end admin-row-action-menu">
                                            <a class="dropdown-item" href="<?php echo e(route($module['route'].'.show', array_merge([$record->getKey()], request()->only(['type','placement','section_key','row_title'])))); ?>"><i class="iconoir-eye"></i><span>View</span></a>
                                            <?php if($module['can_edit'] ?? true): ?>
                                                <a class="dropdown-item" href="<?php echo e(route($module['route'].'.edit', array_merge([$record->getKey()], request()->only(['type','placement','section_key','row_title'])))); ?>"><i class="iconoir-edit-pencil"></i><span>Edit</span></a>
                                            <?php endif; ?>
        ...
        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($module['can_delete'] ?? true): ?>
                <form id="deleteForm<?php echo e($module['key']); ?><?php echo e($record->id); ?>" method="POST" action="<?php echo e(route($module['route'].'.destroy', array_merge([$record->getKey()], request()->only(['type','placement','section_key','row_title'])))); ?>" class="d-none"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?></form>
            <?php endif; ?>
            <?php if(in_array($module['key'], ['expenses','leaves']) && $record->status === 'pending'): ?>
