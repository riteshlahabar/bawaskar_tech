...
<body>
                    ...
                    <div class="col-12">
                        <div class="navbar-top">
                            ...
                            <div class="rightside-box">
                                ...
                                <?php echo $__env->make('store.partials.header-actions', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="user-dashboard-section section-b-space">
        <div class="container-fluid-lg">
            <?php if(! $storeUser): ?>
                <div class="row"><div class="col-12"><div class="alert alert-warning mb-0">Please <a href="<?php echo e(route('store.page', ['page' => 'login', 'redirect_to' => route('store.page', ['page' => 'user-dashboard'])])); ?>">log in</a> to access your account dashboard.</div></div></div>
            <?php else: ?>
                <div class="row">
                    <div class="col-xxl-3 col-lg-4">
                        <div class="dashboard-left-sidebar">
                            ...
                            <div class="profile-box">
                                <div class="cover-image"><img src="<?php echo e(asset('fastkart-store/images/inner-page/cover-img.jpg')); ?>" class="img-fluid blur-up lazyload" alt=""></div>
                                <div class="profile-contain">
                                    <div class="profile-image"><div class="position-relative"><img src="<?php echo e(asset('fastkart-store/images/inner-page/user/1.jpg')); ?>" class="blur-up lazyload update_img" alt="<?php echo e($storeUser->name); ?>"></div></div>
                                    <div class="profile-name"><h3><?php echo e($storeUser->name); ?></h3><h6 class="text-content"><?php echo e($storeUser->email ?: $storeUser->mobile); ?></h6></div>
                                </div>
                            </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel">
                                    <div class="dashboard-home">
                                        <div class="title"><h2>My Dashboard</h2><span class="title-leaf"><svg class="icon-width bg-gray"><use xlink:href="<?php echo e(asset('fastkart-store/svg/leaf.svg')); ?>#leaf"></use></svg></span></div>
                                        <div class="dashboard-user-name"><h6 class="text-content">Hello, <b class="text-title"><?php echo e($storeUser->name); ?></b></h6><p class="text-content">You can review recent orders, confirm shipping details, and manage your account information from this dashboard.</p></div>
                                        <div class="total-box"><div class="row g-sm-4 g-3"><div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6"><div class="total-contain"><img src="<?php echo e(asset('fastkart-store/images/svg/order.svg')); ?>" class="img-1 blur-up lazyload" alt=""><img src="<?php echo e(asset('fastkart-store/images/svg/order.svg')); ?>" class="blur-up lazyload" alt=""><div class="total-detail"><h5>Total Order</h5><h3><?php echo e($orderCount); ?></h3></div></div></div><div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6"><div class="total-contain"><img src="<?php echo e(asset('fastkart-store/images/svg/pending.svg')); ?>" class="img-1 blur-up lazyload" alt=""><img src="<?php echo e(asset('fastkart-store/images/svg/pending.svg')); ?>" class="blur-up lazyload" alt=""><div class="total-detail"><h5>Total Pending Order</h5><h3><?php echo e($pendingOrderCount); ?></h3></div></div></div><div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6"><div class="total-contain"><img src="<?php echo e(asset('fastkart-store/images/svg/wishlist.svg')); ?>" class="img-1 blur-up lazyload" alt=""><img src="<?php echo e(asset('fastkart-store/images/svg/wishlist.svg')); ?>" class="blur-up lazyload" alt=""><div class="total-detail"><h5>Saved Address</h5><h3><?php echo e($addressCount); ?></h3></div></div></div></div></div>
                                        <div class="dashboard-title"><h3>Account Information</h3></div>
                                        <div class="row g-4"><div class="col-xxl-6"><div class="dashboard-content-title"><h4>Contact Information</h4></div><div class="dashboard-detail"><h6 class="text-content"><?php echo e($storeUser->name); ?></h6><h6 class="text-content"><?php echo e($storeUser->email ?: 'Email not available'); ?></h6><h6 class="text-content"><?php echo e($storeUser->mobile ?: 'Mobile not available'); ?></h6></div></div><div class="col-xxl-6"><div class="dashboard-content-title"><h4>Account Status</h4></div><div class="dashboard-detail"><h6 class="text-content">Account Type: <?php echo e(ucfirst($storeUser->role)); ?></h6><h6 class="text-content">Status: <?php echo e(ucwords(str_replace('_', ' ', (string) $storeUser->status))); ?></h6><h6 class="text-content">Last Login: <?php echo e($storeUser->last_login_at?->format('d M Y, h:i A') ?: 'Not available'); ?></h6></div></div><div class="col-12"><div class="dashboard-content-title"><h4>Default Address</h4></div><div class="row g-4"><div class="col-xxl-6"><div class="dashboard-detail"><h6 class="text-content">Default Shipping Address</h6><?php if($storePrimaryAddress): ?><h6 class="text-content"><?php echo e($storePrimaryAddress->name); ?></h6><h6 class="text-content"><?php echo e($storePrimaryAddress->address_line1); ?><?php echo e($storePrimaryAddress->address_line2 ? ', '.$storePrimaryAddress->address_line2 : ''); ?></h6><h6 class="text-content"><?php echo e($storePrimaryAddress->city); ?>, <?php echo e($storePrimaryAddress->state); ?> - <?php echo e($storePrimaryAddress->pincode); ?></h6><h6 class="text-content"><?php echo e($storePrimaryAddress->mobile); ?></h6><?php else: ?><h6 class="text-content">No default address saved yet.</h6><?php endif; ?></div></div><div class="col-xxl-6"><div class="dashboard-detail"><h6 class="text-content">Checkout Flow</h6><h6 class="text-content">You can update delivery address during checkout and place a new order directly from the storefront.</h6><a href="<?php echo e(route('store.page', ['page' => 'checkout'])); ?>">Go to Checkout</a></div></div></div></div></div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="pills-order" role="tabpanel"><div class="dashboard-order"><div class="title"><h2>My Orders History</h2><span class="title-leaf title-leaf-gray"><svg class="icon-width bg-gray"><use xlink:href="<?php echo e(asset('fastkart-store/svg/leaf.svg')); ?>#leaf"></use></svg></span></div><div class="order-contain"><?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php $firstItem = $order->items->first(); $product = $firstItem?->product; $imageUrl = optional($product?->images?->first())->url ?: asset('fastkart-store/images/vegetable/product/1.png'); $status = ucwords(str_replace('_', ' ', (string) $order->status)); $statusClass = in_array((string) $order->status, ['delivered', 'completed'], true) ? 'success-bg' : ''; $quantityTotal = $order->items->sum('quantity'); ?><div class="order-box dashboard-bg-box"><div class="order-container"><div class="order-icon"><i data-feather="box"></i></div><div class="order-detail"><h4><?php echo e($order->order_no); ?> <span class="<?php echo e($statusClass); ?>"><?php echo e($status); ?></span></h4><h6 class="text-content">Placed on <?php echo e($order->created_at?->format('d M Y, h:i A') ?: 'N/A'); ?> | Payment: <?php echo e(ucwords(str_replace('_', ' ', (string) ($order->payment_method ?: 'cod')))); ?></h6></div></div><div class="product-order-detail"><a href="<?php echo e($product ? route('store.product', ['product' => $product->id]) : route('store.page', ['page' => 'shop-left-sidebar'])); ?>" class="order-image"><img src="<?php echo e($imageUrl); ?>" class="blur-up lazyload" alt="<?php echo e($product?->name ?: 'Order item'); ?>"></a><div class="order-wrap"><a href="<?php echo e($product ? route('store.product', ['product' => $product->id]) : route('store.page', ['page' => 'shop-left-sidebar'])); ?>"><h3><?php echo e($product?->name ?: 'Order items'); ?></h3></a><p class="text-content"><?php echo e($order->items->count()); ?> line item(s) in this order. Delivery and stock movement are handled from the live ecommerce backend.</p><ul class="product-size"><li><div class="size-box"><h6 class="text-content">Grand Total : </h6><h5>Rs. <?php echo e(number_format((float) $order->grand_total, 2)); ?></h5></div></li><li><div class="size-box"><h6 class="text-content">Quantity : </h6><h5><?php echo e(rtrim(rtrim(number_format((float) $quantityTotal, 3, '.', ''), '0'), '.')); ?></h5></div></li><li><div class="size-box"><h6 class="text-content">Salesman : </h6><h5><?php echo e($order->salesman?->name ?: 'Assigned later'); ?></h5></div></li><li><div class="size-box"><h6 class="text-content">Order View : </h6><h5><a href="<?php echo e(route('store.page', ['page' => 'order-success'])); ?>">Open Summary</a></h5></div></li></ul></div></div></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><div class="dashboard-detail"><h6 class="text-content">No orders placed yet.</h6><a href="<?php echo e(route('store.page', ['page' => 'shop-left-sidebar'])); ?>">Start Shopping</a></div><?php endif; ?></div></div></div>
                                <div class="tab-pane fade" id="pills-address" role="tabpanel"><div class="dashboard-address"><div class="title"><h2>Saved Addresses</h2><span class="title-leaf title-leaf-gray"><svg class="icon-width bg-gray"><use xlink:href="<?php echo e(asset('fastkart-store/svg/leaf.svg')); ?>#leaf"></use></svg></span></div><div class="row g-sm-4 g-3"><?php $__empty_1 = true; $__currentLoopData = $storeUser->addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $address): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><div class="col-xxl-6 col-xl-6 col-lg-12 col-md-6"><div class="dashboard-detail"><h5 class="text-title mb-2"><?php echo e(ucfirst($address->type ?: 'shipping')); ?> <?php if($address->is_default): ?><span class="badge bg-success ms-2">Default</span><?php endif; ?></h5><h6 class="text-content"><?php echo e($address->name); ?></h6><h6 class="text-content"><?php echo e($address->address_line1); ?><?php echo e($address->address_line2 ? ', '.$address->address_line2 : ''); ?></h6><h6 class="text-content"><?php echo e($address->city); ?>, <?php echo e($address->state); ?> - <?php echo e($address->pincode); ?></h6><h6 class="text-content"><?php echo e($address->mobile); ?></h6></div></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><div class="col-12"><div class="dashboard-detail"><h6 class="text-content">No saved addresses yet. Add one during checkout and save it as default.</h6></div></div><?php endif; ?></div></div></div>
                                <div class="tab-pane fade" id="pills-profile" role="tabpanel"><div class="dashboard-profile"><div class="title"><h2>Profile Details</h2><span class="title-leaf title-leaf-gray"><svg class="icon-width bg-gray"><use xlink:href="<?php echo e(asset('fastkart-store/svg/leaf.svg')); ?>#leaf"></use></svg></span></div><div class="row g-4"><div class="col-md-6"><div class="dashboard-detail"><h6 class="text-content">Name: <?php echo e($storeUser->name); ?></h6><h6 class="text-content">Email: <?php echo e($storeUser->email ?: 'Not available'); ?></h6><h6 class="text-content">Mobile: <?php echo e($storeUser->mobile ?: 'Not available'); ?></h6><h6 class="text-content">Role: <?php echo e(ucfirst($storeUser->role)); ?></h6></div></div><div class="col-md-6"><div class="dashboard-detail"><h6 class="text-content">Status: <?php echo e(ucwords(str_replace('_', ' ', (string) $storeUser->status))); ?></h6><h6 class="text-content">Orders Available: <?php echo e($orderCount); ?></h6><h6 class="text-content">Saved Addresses: <?php echo e($addressCount); ?></h6><form method="POST" action="<?php echo e(route('store.auth.logout')); ?>" class="mt-3"><?php echo csrf_field(); ?><button type="submit" class="btn theme-bg-color text-white btn-md fw-bold">Logout</button></form></div></div></div></div></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Nav & tab upside js -->
    <script src="<?php echo e(asset('fastkart-store/js/nav-tab.js')); ?>"></script>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\user-dashboard.blade.php ENDPATH**/ ?>