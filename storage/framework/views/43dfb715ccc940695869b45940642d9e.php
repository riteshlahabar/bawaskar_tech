...
<head>
    ...
    <meta name="description" content="Bawaskar ERP">
    <meta name="keywords" content="Bawaskar ERP">
    <meta name="author" content="Bawaskar ERP">
    <link rel="shortcut icon" href="<?php echo e(asset('fastkart-invoice/images/icon.png')); ?>" type="image/x-icon">
    <title>Bawaskar ERP Invoice</title>
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('fastkart-invoice/css/style.css')); ?>">
                    ...
                    <div class="invoice-wrapper">
                        <div class="invoice-header">
                            <div class="header-image">
                                <img src="<?php echo e(asset('fastkart-invoice/images/logo.svg')); ?>" class="img-fluid" alt="logo">
                            </div>
                        ...
                        <div class="invoice-footer">
                            <div class="signature-box">
                                <img src="<?php echo e(asset('fastkart-invoice/images/sign.png')); ?>" class="img-fluid" alt="">
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\invoices\fastkart-preview\invoice-1.blade.php ENDPATH**/ ?>