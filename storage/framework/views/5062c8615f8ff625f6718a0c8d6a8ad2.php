...
<ul class="navbar-nav">
        ...
        <div class="dropdown-menu dropdown-menu-2 dropdown-menu-left">
            <div class="row">
                ...
                <div class="dropdown-column col-xl-3">
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page' => 'user-dashboard'])); ?>">Customer Dashboard</a>
    ...
    <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="<?php echo e(route('store.page', ['page' => 'login'])); ?>" data-bs-toggle="dropdown">Dealer</a>
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="<?php echo e(route('store.page', ['page' => 'login'])); ?>">Dealer Login</a></li>
            <li><a class="dropdown-item" href="<?php echo e(route('store.page', ['page' => 'sign-up'])); ?>">Dealer Registration</a></li>
...
</ul><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views/store/partials/navbar.blade.php ENDPATH**/ ?>