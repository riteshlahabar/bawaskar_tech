            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                                                        <form method="POST" action="<?php echo e(route('store.auth.login')); ?>" class="row g-4">
                                <?php echo csrf_field(); ?>
                                <?php ($selectedRole = old('role', request('role', 'customer'))); ?>
                                <input type="hidden" name="redirect_to" value="<?php echo e(request('redirect_to', route('store.page', ['page' => 'user-dashboard']))); ?>">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input type="text" class="form-control" id="login" name="login" value="<?php echo e(old('login')); ?>" placeholder="Email Address or Mobile Number">
