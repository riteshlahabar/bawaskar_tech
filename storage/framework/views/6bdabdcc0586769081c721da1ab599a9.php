            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                    <div class="image-contain">
                        <img src="<?php echo e(asset('fastkart-store/images/inner-page/log-in.png')); ?>" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                            ...
                            <form class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="forgot-box">
                                        ...
                                        <a href="<?php echo e(route('store.page', ['page'=>'forgot'])); ?>" class="forgot-password">Forgot Password?</a>
                                    </div>
                                </div>
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.google.com/" class="btn google-button w-100">
                                        <img src="<?php echo e(asset('fastkart-store/images/inner-page/google.png')); ?>" class="blur-up lazyload"
                                            alt=""> Log In with Google
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.facebook.com/" class="btn google-button w-100">
                                        <img src="<?php echo e(asset('fastkart-store/images/inner-page/facebook.png')); ?>" class="blur-up lazyload"
                        ...
                        <div class="sign-up-box">
                            ...
                            <a href="<?php echo e(route('store.page', ['page'=>'sign-up'])); ?>">Sign Up</a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\login.blade.php ENDPATH**/ ?>