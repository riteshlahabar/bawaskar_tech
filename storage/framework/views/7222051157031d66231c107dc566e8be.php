                        ...
                        <tr class="header" style="display: flex;align-items: center;justify-content: space-around;">
                            <td>
                                <ul>
                                    <li style="font-size: 14px;">
                                        <a href="<?php echo e(route('store.home')); ?>" style="color: #252525;">Home</a>
                                    </li>
                                    <li style="margin-left: 21px; font-size: 14px;">
                                        <a href="<?php echo e(route('store.page', ['page'=>'wishlist'])); ?>" style="color: #252525;">Wishlist</a>
                                    </li>
                                </ul>
                            </td>
                            ...
                            <td class="header-logo" style="text-align: center; display: block;" align="top">
                                <a href="<?php echo e(route('store.home')); ?>">
                                    <img src="<?php echo e(asset('fastkart-email/images/logo.png')); ?>" alt="" class="main-logo">
                                </a>
                            </td>
                            ...
                            <td>
                                <ul>
                                    <li style="font-size: 14px;">
                                        <a href="<?php echo e(route('store.page', ['page'=>'cart'])); ?>" style="color: #252525;">My Cart</a>
                                    </li>
                                    <li style="margin-left: 21px; font-size: 14px;">
                                        <a href="<?php echo e(route('store.page', ['page'=>'contact-us'])); ?>" style="color: #252525;">Contact</a>
                                    </li>
                                </ul>
                            </td>
                        </tr>
                        ...
                        <tbody>
                            <tr class="content-tr text-center">
                                ...
                                <td style="display: block; margin-top: 30px;">
                                    <img src="<?php echo e(asset('fastkart-email/images/abandonment-poster.png')); ?>" style="width: 100%;" alt=""
                                        class="main-logo">
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="product-table"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="product-detail">
                                        <img src="<?php echo e(asset('fastkart-email/images/product-1.png')); ?>" alt="">
                            ...
                            <tr>
                                <td>
                                    <div class="product-detail">
                                        <img src="<?php echo e(asset('fastkart-email/images/product-2.png')); ?>" alt="">
                            ...
                            <tr>
                                <td>
                                    <div class="product-detail">
                                        <img src="<?php echo e(asset('fastkart-email/images/product-3.png')); ?>" alt="">
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\emails\fastkart\abandonment-email.blade.php ENDPATH**/ ?>