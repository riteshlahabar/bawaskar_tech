                ...
                <div class="col-12">
                    <div class="slider-4-2 product-wrapper">
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo e(asset('fastkart-store/images/inner-page/faq/start.png')); ?>" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo e(asset('fastkart-store/images/inner-page/faq/help.png')); ?>" class="blur-up lazyload" alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo e(asset('fastkart-store/images/inner-page/faq/price.png')); ?>" class="blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="faq-top-box">
                                <div class="faq-box-icon">
                                    <img src="<?php echo e(asset('fastkart-store/images/inner-page/faq/contact.png')); ?>" class="blur-up lazyload"
                                        alt="">
                                </div>
                    ...
                    <div class="faq-contain">
                        ...
                        <p>We are answering most frequent questions. No worries if you not find exact one. You can find
                            out more by searching or continuing clicking button below or directly <a
                                href="<?php echo e(route('store.page', ['page'=>'contact-us'])); ?>" class="theme-color text-decoration-underline">contact our
                                support.</a></p>
                    </div>
                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is Bawaskar Farmer Store and why was the name changed? <i
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        <p>Bawaskar Farmer Store is leading the charge in transforming India's vast, unorganised
                                        ...
                                        <p>To know the reason why we changed our brand name from Grofers to Bawaskar Farmer Store,
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\faq.blade.php ENDPATH**/ ?>