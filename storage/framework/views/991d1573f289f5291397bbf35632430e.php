                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0 bg-<?php echo e($stat['color']); ?>-subtle text-<?php echo e($stat['color']); ?> thumb-xl rounded-circle d-flex align-items-center justify-content-center">
                            <i class="admin-dashboard-card-icon" data-feather="<?php echo e($dashboardCardIcons[$stat['icon']] ?? 'circle'); ?>"></i>
                        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\admin\dashboard\index.blade.php ENDPATH**/ ?>