...
<body>
    ...
    <section class="checkout-section-2 section-b-space">
        <div class="container-fluid-lg">
            <?php if(! $storeUser): ?>
                <div class="alert alert-warning mb-0">Please <a href="<?php echo e(route('store.page', ['page' => 'login', 'redirect_to' => route('store.page', ['page' => 'checkout'])])); ?>">log in</a> before checkout.</div>
            <?php elseif($cartItems->isEmpty()): ?>
                <div class="alert alert-light mb-0">Your cart is empty. <a href="<?php echo e(route('store.page', ['page' => 'shop-left-sidebar'])); ?>">Browse products</a>.</div>
            <?php else: ?>
                <form method="POST" action="<?php echo e(route('store.checkout.place-order')); ?>">
                    <?php echo csrf_field(); ?>
                                        ...
                                        <li>
                                            ...
                                            <div class="checkout-box">
                                                ...
                                                <div class="checkout-detail">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="delivery-address-box">
                                                                    <div>
                                                                        ...
                                                                        <div class="label"><label><?php echo e(ucfirst($address->type ?: 'shipping')); ?></label></div>
                                                                        <ul class="delivery-address-detail">
                                                                            <li><h4 class="fw-500"><?php echo e($address->name); ?></h4></li>
                                                                            <li><p class="text-content"><span class="text-title">Address :</span> <?php echo e($address->address_line1); ?><?php echo e($address->address_line2 ? ', '.$address->address_line2 : ''); ?>, <?php echo e($address->city); ?>, <?php echo e($address->state); ?></p></li>
                                                                            <li><h6 class="text-content"><span class="text-title">Pin Code :</span> <?php echo e($address->pincode); ?></h6></li>
                                                                            <li><h6 class="text-content mb-0"><span class="text-title">Phone :</span> <?php echo e($address->mobile); ?></h6></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="row g-3">
                                                        <div class="col-md-6"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="contact_name" id="contact_name" value="<?php echo e(old('contact_name', $address?->name ?: $storeUser->name)); ?>" placeholder="Contact Name"><label for="contact_name">Contact Name</label></div></div>
                                                        <div class="col-md-6"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="contact_mobile" id="contact_mobile" value="<?php echo e(old('contact_mobile', $address?->mobile ?: $storeUser->mobile)); ?>" placeholder="Contact Mobile"><label for="contact_mobile">Contact Mobile</label></div></div>
                                                        <div class="col-md-4"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="address_type" id="address_type" value="<?php echo e(old('address_type', $address?->type ?: 'shipping')); ?>" placeholder="Address Type"><label for="address_type">Address Type</label></div></div>
                                                        <div class="col-md-8"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="address_line1" id="address_line1" value="<?php echo e(old('address_line1', $address?->address_line1)); ?>" placeholder="Address Line 1"><label for="address_line1">Address Line 1</label></div></div>
                                                        <div class="col-12"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="address_line2" id="address_line2" value="<?php echo e(old('address_line2', $address?->address_line2)); ?>" placeholder="Address Line 2"><label for="address_line2">Address Line 2</label></div></div>
                                                        <div class="col-md-4"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="city" id="city" value="<?php echo e(old('city', $address?->city)); ?>" placeholder="City"><label for="city">City</label></div></div>
                                                        <div class="col-md-4"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="state" id="state" value="<?php echo e(old('state', $address?->state)); ?>" placeholder="State"><label for="state">State</label></div></div>
                                                        <div class="col-md-4"><div class="form-floating theme-form-floating"><input type="text" class="form-control" name="pincode" id="pincode" value="<?php echo e(old('pincode', $address?->pincode)); ?>" placeholder="Pincode"><label for="pincode">Pincode</label></div></div>
                                                        <div class="col-12"><div class="form-check custom-form-check"><input class="form-check-input" type="checkbox" name="save_as_default" id="save_as_default" value="1" <?php echo e(old('save_as_default', $address?->is_default) ? 'checked' : ''); ?>><label class="form-check-label" for="save_as_default">Save as default address</label></div></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <div class="checkout-box">
                                                ...
                                                <div class="checkout-detail">
                                                    ...
                                                    <div class="mt-4"><div class="form-floating theme-form-floating"><textarea class="form-control" name="notes" id="notes" placeholder="Order Notes" style="height: 120px"><?php echo e(old('notes')); ?></textarea><label for="notes">Order Notes</label></div></div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="summery-box-2">
                                    ...
                                    <ul class="summery-contain">
                                        <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $imageUrl = optional($item['product']->images->first())->url ?: asset('fastkart-store/images/vegetable/product/1.png'); ?>
                                            <li>
                                                <img src="<?php echo e($imageUrl); ?>" class="img-fluid blur-up lazyloaded checkout-image" alt="<?php echo e($item['product']->name); ?>">
                                                <h4><?php echo e($item['product']->name); ?> <span>X <?php echo e(number_format((float) $item['quantity'], 3)); ?></span></h4>
                                                <h4 class="price">Rs. <?php echo e(number_format((float) $item['line_total'], 2)); ?></h4>
                                            </li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                    <ul class="summery-total">
                                        <li><h4>Subtotal</h4><h4 class="price">Rs. <?php echo e(number_format((float) data_get($storeCart, 'subtotal', 0), 2)); ?></h4></li>
                                        <li><h4>Shipping</h4><h4 class="price">Rs. 0.00</h4></li>
                                        <li><h4>Tax</h4><h4 class="price">Rs. <?php echo e(number_format((float) data_get($storeCart, 'gst_total', 0), 2)); ?></h4></li>
                                        <li><h4>Coupon/Code</h4><h4 class="price">Rs. 0.00</h4></li>
                                        <li class="list-total"><h4>Total (INR)</h4><h4 class="price">Rs. <?php echo e(number_format((float) data_get($storeCart, 'grand_total', 0), 2)); ?></h4></li>
                                    </ul>
                                </div>
                                <div class="checkout-offer">
                                    <div class="offer-title">
                                        <div class="offer-icon"><img src="<?php echo e(asset('fastkart-store/images/inner-page/offer.svg')); ?>" class="img-fluid" alt=""></div>
