...
<body>
                    ...
                    <div class="right-side-summery-box">
                        <div class="summery-box-2">
                            ...
                            <ul class="summery-contain">
                                ...
                                <li>
                                    <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/3.png')); ?>"
                                        class="img-fluid blur-up lazyloaded checkout-image" alt="">
                                ...
                                <li>
                                    <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/5.png')); ?>"
                                        class="img-fluid blur-up lazyloaded checkout-image" alt="">
                                ...
                                <li>
                                    <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/6.png')); ?>"
                                        class="img-fluid blur-up lazyloaded checkout-image" alt="">
                        ...
                        <div class="checkout-offer">
                            <div class="offer-title">
                                <div class="offer-icon">
                                    <img src="<?php echo e(asset('fastkart-store/images/inner-page/offer.svg')); ?>" class="img-fluid" alt="">
                                </div>
    ...
    <!-- Lord-icon Js -->
    <script src="<?php echo e(asset('fastkart-store/js/lusqsztk.js')); ?>"></script>
    ...
    <!-- Delivery Option js -->
    <script src="<?php echo e(asset('fastkart-store/js/delivery-option.js')); ?>"></script>
    ...
    <!-- Quantity js -->
    <script src="<?php echo e(asset('fastkart-store/js/quantity.js')); ?>"></script>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\checkout.blade.php ENDPATH**/ ?>