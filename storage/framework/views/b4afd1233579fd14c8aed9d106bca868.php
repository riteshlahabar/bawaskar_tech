                ...
                <td>
                    ...
                    <table class="content-table" style="margin-bottom: -6px;" align="center" border="0" cellpadding="0"
                        ...
                        <thead>
                            <tr>
                                <td>
                                    <img src="<?php echo e(asset('fastkart-email/images/welcome-poster.jpg')); ?>" alt="">
                                </td>
                            </tr>
                        </thead>
                    </table>
                            ...
                            <tr style="display: block;">
                                <td style="display: block;">
                                    <h3
                                        ...
                                        Hi Jonny And Welcome To <?php echo e(config('admin.brand.name', 'Bawaskar ERP')); ?>.!</h3>
                                </td>
                                ...
                                <td style="display: block;">
                                    <p
                                        ...
                                        If you have any question, please email us at <span
                                            class="theme-color"><?php echo e(config('admin.brand.name', 'Bawaskar ERP')); ?>@example.com</span> or vixit our <span
                                    ...
                                    <tr>
                                        <td>
                                            <h4 style="font-size: 19px; font-weight: 700; margin: 0;">Shop For <span
                                                    class="theme-color"><?php echo e(config('admin.brand.name', 'Bawaskar ERP')); ?></span></h4>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellpadding="0" cellspacing="0" class="footer-social-icon text-center"
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\emails\fastkart\welcome.blade.php ENDPATH**/ ?>