                    ...
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                    <img src="<?php echo e(asset('fastkart-store/images/cake/product/2.png')); ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                    <img src="<?php echo e(asset('fastkart-store/images/cake/product/3.png')); ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                    <img src="<?php echo e(asset('fastkart-store/images/cake/product/4.png')); ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                    <img src="<?php echo e(asset('fastkart-store/images/cake/product/5.png')); ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                    <img src="<?php echo e(asset('fastkart-store/images/cake/product/6.png')); ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                    <img src="<?php echo e(asset('fastkart-store/images/cake/product/7.png')); ?>" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\wishlist.blade.php ENDPATH**/ ?>