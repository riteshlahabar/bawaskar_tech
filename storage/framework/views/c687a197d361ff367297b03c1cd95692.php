                                    ...
                                    <tr class="product-box-contain">
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>" class="product-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/1.png')); ?>"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Bell pepper</a>
                                                        </li>
                                        ...
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Eggplant</a>
                                                        </li>
                                        ...
                                        <td class="product-detail">
                                            <div class="product border-0">
                                                ...
                                                <div class="product-detail">
                                                    <ul>
                                                        <li class="name">
                                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Onion</a>
                                                        </li>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\cart.blade.php ENDPATH**/ ?>