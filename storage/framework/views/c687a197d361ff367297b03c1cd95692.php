                                                ...
                                                <tr class="product-box-contain">
                                                    <td class="product-detail">
                                                        <div class="product border-0">
                                                            <a href="<?php echo e($productUrl); ?>" class="product-image">
                                                                <img src="<?php echo e($imageUrl); ?>" class="img-fluid blur-up lazyload" alt="<?php echo e($product->name); ?>">
                                                            </a>
                                                            <div class="product-detail">
                                                                <ul>
                                                                    <li class="name"><a href="<?php echo e($productUrl); ?>"><?php echo e($product->name); ?></a></li>
                                                                    <li class="text-content"><span class="text-title">Category:</span> <?php echo e(data_get($product, 'category.name') ?: 'Product'); ?></li>
                                                                    <li class="text-content"><span class="text-title">Quantity</span> - <?php echo e(number_format((float) $item['quantity'], 3)); ?> <?php echo e($unitName); ?></li>
                                                                    <li>
                                                                        <h5 class="text-content d-inline-block">Price :</h5>
                                                                        <span>Rs. <?php echo e(number_format((float) $item['unit_price'], 2)); ?></span>
                                                                        <?php if($mrp > (float) $item['unit_price']): ?>
                                                                            <span class="text-content">Rs. <?php echo e(number_format($mrp, 2)); ?></span>
                                                                        <?php endif; ?>
                                                                    </li>
                                                                    <?php if($savings > 0): ?>
                                                                        <li><h5 class="saving theme-color">Saving : Rs. <?php echo e(number_format($savings, 2)); ?></h5></li>
                                                                    <?php endif; ?>
                                                                    <?php if($item['has_issue']): ?>
                                                                        <li><h6 class="text-danger">Available stock: <?php echo e(number_format((float) $item['available_stock'], 3)); ?></h6></li>
                                                                    <?php endif; ?>
                                                                    <li class="quantity-price-box">
                                                                        <div class="cart_qty">
                                                                            <div class="input-group">
                                                                                <input class="form-control input-number qty-input" type="number" min="0" step="0.001" name="items[<?php echo e($product->id); ?>]" value="<?php echo e($item['quantity']); ?>">
                                                                            </div>
                                                                        </div>
                                                                    </li>
                                                                    <li><h5>Total: Rs. <?php echo e(number_format((float) $item['line_total'], 2)); ?></h5></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="price">
                                                        ...
                                                        <h5>Rs. <?php echo e(number_format((float) $item['unit_price'], 2)); ?> <?php if($mrp > (float) $item['unit_price']): ?><del class="text-content">Rs. <?php echo e(number_format($mrp, 2)); ?></del><?php endif; ?></h5>
                                                        <?php if($savings > 0): ?>
                                                            <h6 class="theme-color">You Save : Rs. <?php echo e(number_format($savings, 2)); ?></h6>
                                                        <?php endif; ?>
                                                    </td>
                                                    <td class="quantity">
                                                    ...
                                                    <td class="subtotal">
                                                        ...
                                                        <h5>Rs. <?php echo e(number_format((float) $item['line_total'], 2)); ?></h5>
                                                    </td>
                                                    <td class="save-remove">
                                                        <h4 class="table-title text-content">Action</h4>
                                                        <button type="submit" formaction="<?php echo e(route('store.cart.remove', ['productId' => $product->id])); ?>" class="remove close_button border-0 bg-transparent">Remove</button>
                                                    </td>
                                                </tr>
                        ...
                        <div class="col-xxl-3">
                            <div class="summery-box p-sticky">
                                ...
                                <div class="summery-contain">
                                    ...
                                    <ul>
                                        <li><h4>Items</h4><h4 class="price"><?php echo e(rtrim(rtrim(number_format((float) data_get($storeCart, 'count', 0), 3, '.', ''), '0'), '.') ?: '0'); ?></h4></li>
                                        <li><h4>Subtotal</h4><h4 class="price">Rs. <?php echo e(number_format((float) data_get($storeCart, 'subtotal', 0), 2)); ?></h4></li>
                                        <li><h4>GST</h4><h4 class="price">Rs. <?php echo e(number_format((float) data_get($storeCart, 'gst_total', 0), 2)); ?></h4></li>
                                ...
                                <ul class="summery-total">
                                    <li class="list-total border-top-0">
                                        <h4>Total (INR)</h4>
                                        <h4 class="price theme-color">Rs. <?php echo e(number_format((float) data_get($storeCart, 'grand_total', 0), 2)); ?></h4>
                                    </li>
                                </ul>
                                ...
                                <div class="button-group cart-button">
                                    <ul>
                                        ...
                                        <li><a href="<?php echo e(route('store.page', ['page' => 'checkout'])); ?>" class="btn btn-animation proceed-btn fw-bold">Process To Checkout</a></li>
                                        <li><button type="submit" formaction="<?php echo e(route('store.cart.clear')); ?>" class="btn btn-light shopping-button text-dark">Clear Cart</button></li>
                                        <li><a href="<?php echo e(route('store.page', ['page' => 'shop-left-sidebar'])); ?>" class="btn btn-light shopping-button text-dark"><i class="fa-solid fa-arrow-left-long"></i>Return To Shopping</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
