...
<body>
                            ...
                            <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky">
                                <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                                    ...
                                    <div class="offcanvas-body">
                                        <ul class="navbar-nav">
                                                                                        <li class="nav-item">
                                                <a class="nav-link" href="<?php echo e(route('store.home')); ?>">Home</a>
                                            </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    Thumbnail</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Images</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Slider</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Sticky</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Accordion</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Tab</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Digital</a>

                                                                <h5 class="custom-mt dropdown-header">Product Features
                                                                </h5>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Bundle (Cross Sale)</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Hot Stock
                                                                    Progress <label class="menu-label">New</label>
                                                                </a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">SOLD OUT</a>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Circle <label
                                                                        class="menu-label">New</label></a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Image
                                                                    Swatch</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Color</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Radio Button</a>
                                                                <a class="dropdown-item"
                                                                ...
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    Checkout</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Dynamic Checkout</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Secure Checkout</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Active Product view</a>
                                                                <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                                                    Active
                                                                    Last Orders
                                                                </a>
                                                        ...
                                                        <div class="col-xl-3">
                                                            <div class="dropdown-column m-0">
                                                                <h5 class="dropdown-header">
                                                                    Product Features </h5>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Simple</a>
                                                                <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                                                    Product Classified <label
                                                                        class="menu-label">New</label>
                                                                </a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Size Chart <label
                                                                        class="menu-label">New</label></a>
                                                                <a class="dropdown-item"
                                                                ...
                                                                <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Store
                                                                    Information</a>
                                                                <a class="dropdown-item"
                                                                    href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Social Share <label
                                                ...
                                                <div class="dropdown-menu dropdown-menu-2">
                                                    <div class="row">
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Broccoli & Cauliflower</a>

                                                            <a href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>"
                                                                class="dropdown-item">Chilies, Garlic</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Vegetables & Salads</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Gourd, Cucumber</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Chilies, Garlic</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Potatoes & Tomatoes</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Asparagus & Artichokes</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Avocados & Peppers</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Broccoli & Zucchini</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Celery, Fennel & Leeks</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Chilies & Lime</a>
                                                        </div>
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Seller Grid
                                                            2</a>
                                                    </li>
                                                </ul>
                                            </li>
    ...
    <?php if($storeProduct): ?>
        <?php echo $__env->make('store.partials.product-detail-main', ['product' => $storeProduct], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
                    ...
                    <div class="row g-4">
                                        ...
                                        <div class="product-main-2 no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/1.jpg')); ?>" id="img-1"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/2.jpg')); ?>"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/3.jpg')); ?>"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/4.jpg')); ?>"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/5.jpg')); ?>"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/6.jpg')); ?>"
                                        ...
                                        <div class="left-slider-image-2 left-slider no-arrow slick-top">
                                            <div>
                                                <div class="sidebar-image">
                                                    <img src="<?php echo e(asset('fastkart-store/images/product/category/1.jpg')); ?>"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="right-box-contain">
                                ...
                                <div class="buy-box">
                                    <a href="<?php echo e(route('store.page', ['page'=>'wishlist'])); ?>">
                                        <i data-feather="heart"></i>
                                ...
                                <div class="payment-option">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="<?php echo e(asset('fastkart-store/images/product/payment/1.svg')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="<?php echo e(asset('fastkart-store/images/product/payment/2.svg')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="<?php echo e(asset('fastkart-store/images/product/payment/3.svg')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="<?php echo e(asset('fastkart-store/images/product/payment/4.svg')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void(0)">
                                                <img src="<?php echo e(asset('fastkart-store/images/product/payment/5.svg')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="description" role="tabpanel">
                                        <div class="product-description">
                                            ...
                                            <div class="banner-contain nav-desh">
                                                <img src="<?php echo e(asset('fastkart-store/images/vegetable/banner/14.jpg')); ?>"
                                                                    ...
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="<?php echo e(asset('fastkart-store/images/review/1.jpg')); ?>">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="<?php echo e(asset('fastkart-store/images/review/2.jpg')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="<?php echo e(asset('fastkart-store/images/review/3.jpg')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="<?php echo e(asset('fastkart-store/images/review/4.jpg')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image people-text">
                                                                            <img alt="user" class="img-fluid "
                                                                                src="<?php echo e(asset('fastkart-store/images/review/5.jpg')); ?>">
                                                                        </div>
                                                                    </div>
                                                                    <div class="people-comment">
                                                                        <div class="people-name"><a
                    ...
                    <div class="right-sidebar-box">
                        <div class="vendor-box">
                            <div class="vendor-contain">
                                <div class="vendor-image">
                                    <img src="<?php echo e(asset('fastkart-store/images/product/vendor.png')); ?>" class="blur-up lazyload" alt="">
                                </div>
                                ...
                                <ul class="product-list product-right-sidebar border-0 p-0">
                                    <li>
                                        <div class="offer-product">
                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>" class="offer-image">
                                                <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/23.png')); ?>"
                                                    class="img-fluid blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>" class="offer-image">
                                                <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/24.png')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li>
                                        <div class="offer-product">
                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>" class="offer-image">
                                                <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/25.png')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                                    ...
                                    <li class="mb-0">
                                        <div class="offer-product">
                                            <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>" class="offer-image">
                                                <img src="<?php echo e(asset('fastkart-store/images/vegetable/product/26.png')); ?>"
                                                    class="blur-up lazyload" alt="">
                                            </a>
                        ...
                        <div class="ratio_156 pt-25">
                            <div class="home-contain">
                                <img src="<?php echo e(asset('fastkart-store/images/vegetable/banner/8.jpg')); ?>" class="bg-img blur-up lazyload"
                                    alt="">
            ...
            <div class="title">
                ...
                <span class="title-leaf">
                    <svg class="icon-width">
                        <use xlink:href="<?php echo e(asset('fastkart-store/svg/leaf.svg')); ?>#leaf"></use>
                    </svg>
                </span>
            </div>
            <div class="row">
                                ...
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="product-left.htm">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/11.png')); ?>"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/2.png')); ?>"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/3.png')); ?>"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/4.png')); ?>"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/5.png')); ?>"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/6.png')); ?>"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <div class="product-box-3 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-header">
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/cake/product/7.png')); ?>" class="img-fluid" alt="">
                                        </a>
    ...
    <div class="add-cart-box">
        <div class="add-image">
            <img src="<?php echo e(asset('fastkart-store/images/cake/pro/1.jpg')); ?>" class="img-fluid" alt="">
        </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cart-content">
                        ...
                        <div class="add-btn">
                            <a class="btn theme-bg-color text-white wishlist-btn" href="<?php echo e(route('store.page', ['page'=>'wishlist'])); ?>"><i
                                    class="fa fa-bookmark"></i> Wishlist</a>
                            <a class="btn theme-bg-color text-white" href="<?php echo e(route('store.page', ['page'=>'cart'])); ?>"><i
                        ...
                        <div class="product-wrapper">
                            <div class="product-image">
                                <img class="img-fluid" alt="Solid Collared Tshirts"
                                    src="<?php echo e(asset('fastkart-store/images/fashion/product/26.jpg')); ?>">
                            </div>
    ...
    <!-- sidebar open js -->
    <script src="<?php echo e(asset('fastkart-store/js/filter-sidebar.js')); ?>"></script>

    <!-- Quantity js -->
    <script src="<?php echo e(asset('fastkart-store/js/quantity-2.js')); ?>"></script>

    <!-- Zoom Js -->
    <script src="<?php echo e(asset('fastkart-store/js/jquery.elevatezoom.js')); ?>"></script>
    <script src="<?php echo e(asset('fastkart-store/js/zoom-filter.js')); ?>"></script>

    <!-- Timer Js -->
    <script src="<?php echo e(asset('fastkart-store/js/timer1.js')); ?>"></script>

    <!-- Sticky-bar js -->
    <script src="<?php echo e(asset('fastkart-store/js/sticky-cart-bottom.js')); ?>"></script>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\product-left-thumbnail.blade.php ENDPATH**/ ?>