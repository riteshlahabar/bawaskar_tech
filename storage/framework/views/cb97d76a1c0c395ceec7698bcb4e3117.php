...
<body>
    ...
    <?php echo $__env->make('store.partials.shop-products-main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="add-cart-box">
        <div class="add-image">
            <img src="<?php echo e(asset('fastkart-store/images/cake/pro/1.jpg')); ?>" class="img-fluid blur-up lazyload" alt="">
        </div>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\shop-left-sidebar.blade.php ENDPATH**/ ?>