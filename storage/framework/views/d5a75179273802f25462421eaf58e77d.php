                                                ...
                                                <div class="dropdown-menu dropdown-menu-2">
                                                    <div class="row">
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Broccoli
                                                                & Cauliflower</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Gourd,
                                                                Cucumber</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Chilies,
                                                                Garlic</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Potatoes
                                                                & Tomatoes</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Asparagus
                                                                & Artichokes</a>

                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Avocados
                                                                & Peppers</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Celery,
                                                                Fennel & Leeks</a>
    ...
    <section class="section-404 section-lg-space">
        <div class="container-fluid-lg">
            <div class="row">
                <div class="col-12">
                    <div class="image-404">
                        <img src="<?php echo e(asset('fastkart-store/images/inner-page/404.png')); ?>" class="img-fluid blur-up lazyload" alt="">
                    </div>
                </div>
...
</html><?php /**PATH C:\All Project flutter laravel reactjs python\Bawaskar Technology\bawaskar_erp\resources\views\store\pages\404.blade.php ENDPATH**/ ?>