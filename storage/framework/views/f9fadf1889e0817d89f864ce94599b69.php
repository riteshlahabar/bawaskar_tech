            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                                                        <form method="POST" action="<?php echo e(route('store.auth.register')); ?>" class="row g-4">
                                <?php echo csrf_field(); ?>
                                <?php ($selectedRole = old('role', request('role', 'customer'))); ?>
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating">
                                        <select class="form-select" id="signupRole" name="role">
                                            <option value="customer" <?php echo e($selectedRole === 'customer' ? 'selected' : ''); ?>>Customer</option>
                                            <option value="dealer" <?php echo e($selectedRole === 'dealer' ? 'selected' : ''); ?>>Dealer</option>
                                        </select>
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating">
                                        <input type="text" class="form-control" id="fullname" name="name" value="<?php echo e(old('name')); ?>" placeholder="Full Name">
                                        <label for="fullname">Full Name</label>
                                    </div>
                                </div>
                                <div class="col-12 dealer-only-field">
                                    <div class="form-floating theme-form-floating">
                                        <input type="text" class="form-control" id="firm_name" name="firm_name" value="<?php echo e(old('firm_name')); ?>" placeholder="Firm Name">
                                        <label for="firm_name">Firm Name</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating">
                                        <input type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Email Address">
                                        <label for="email">Email Address</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating">
                                        <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo e(old('mobile')); ?>" placeholder="Mobile Number">
                                        <label for="mobile">Mobile Number</label>
                                    </div>
                                </div>
                                <div class="col-12 dealer-only-field">
                                    <div class="form-floating theme-form-floating">
                                        <input type="text" class="form-control" id="gst_number" name="gst_number" value="<?php echo e(old('gst_number')); ?>" placeholder="GST Number">
