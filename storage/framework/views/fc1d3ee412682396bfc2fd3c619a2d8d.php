...
?>
                        ...
                        <div class="main-nav navbar navbar-expand-xl navbar-light navbar-sticky p-0">
                            <div class="offcanvas offcanvas-collapse order-xl-2" id="primaryMenu">
                                ...
                                <div class="offcanvas-body">
                                    <ul class="navbar-nav">
                                                                                <li class="nav-item">
                                            <a class="nav-link ps-0" href="<?php echo e(route('store.home')); ?>">Home</a>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop
                                                        Category Slider</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop Banner</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop Left
                                                        Sidebar</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop List</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop
                                                        Right Sidebar</a>
                                                ...
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Shop Top
                                                        Filter</a>
                                                </li>
                                            </ul>
                                        </li>
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-3">
                                                        <div class="dropdown-column m-0">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Thumbnail</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Images</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Slider</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Sticky</a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Accordion</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Tab</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Digital</a>
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Bundle
                                                                (Cross Sale)</a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Hot Stock
                                                                Progress <label class="menu-label">New</label>
                                                            </a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">SOLD
                                                                OUT</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                                                Sale Countdown</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3">
                                                        <div class="dropdown-column m-0">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Rectangle</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant
                                                                Circle <label class="menu-label">New</label></a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Image
                                                                Swatch</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant
                                                                Color</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant
                                                                Radio Button</a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Variant Dropdown</a>
                                                            <h5 class="custom-mt dropdown-header">Product Features
                                                            </h5>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Sticky
                                                                Checkout</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Dynamic
                                                                Checkout</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Secure
                                                                Checkout</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Active
                                                                Product view</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                                                Active
                                                                Last Orders
                                                    ...
                                                    <div class="col-xl-3">
                                                        <div class="dropdown-column m-0">
                                                            ...
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Size
                                                                Chart <label class="menu-label">New</label></a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Delivery &
                                                                Return</a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product Review</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Ask
                                                                an Expert</a>
                                                            <h5 class="custom-mt dropdown-header">Product Features
                                                            </h5>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Product
                                                                Tags</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Store
                                                                Information</a>
                                                            <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Social
                                                                Share <label
                                                                    class="menu-label warning-label">Hot</label>
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Related Products
                                                                <label class="menu-label warning-label">Hot</label>
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">Wishlist &
                                                                Compare</a>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-3 d-xl-block d-none">
                                                        <div class="dropdown-column m-0">
                                                            <div class="menu-img-banner">
                                                                <a class="text-title" href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                                                    <img src="<?php echo e(asset('fastkart-store/images/mega-menu.png')); ?>"
                                                                        alt="banner">
                                                                </a>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-2 dropdown-menu-left">
                                                <div class="row">
                                                    <div class="dropdown-column col-xl-3">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Beans &
                                                            Brinjals</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Broccoli
                                                            & Cauliflower</a>

                                                        <a href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>" class="dropdown-item">Chilies,
                                                            Garlic, Lemon & Ginger</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Cut
                                                            Vegetables & Salads</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Gourd,
                                                            Cucumber & Pumpkin</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Herbs &
                                                            Sprouts</a>
                                                    ...
                                                    <div class="dropdown-column col-xl-3">
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Chilies,
                                                            Garlic, Lemon & Ginger</a>
                                                        ...
                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Onions,
                                                            Potatoes & Tomatoes</a>

                                                        <a href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>" class="dropdown-item">Peas &
                                                            Corn</a>
                                                    </div>

                                                    <div class="dropdown-column col-xl-3">
                                                        <h5 class="dropdown-header">Exotic Vegetables</h5>
                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Asparagus
                                                            & Artichokes</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Avocados
                                                            & Peppers</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Broccoli
                                                            & Zucchini</a>

                                                        <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'shop-left-sidebar'])); ?>">Celery,
                                                            Fennel & Leeks</a>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Blog Detail</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Blog Grid</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Blog List</a>
                                                </li>
                                            </ul>
                                        </li>
                                            ...
                                            <ul class="dropdown-menu">
                                                <li class="sub-dropdown-hover">
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li>
                                                            <a
                                                                href="<?php echo e(route('store.email-preview', ['template'=>'abandonment-email'])); ?>">Abandonment</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(route('store.email-preview', ['template'=>'offer-template'])); ?>">Offer
                                                                Template</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(route('store.email-preview', ['template'=>'order-success'])); ?>">Order
                                                                Success</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(route('store.email-preview', ['template'=>'reset-password'])); ?>">Reset
                                                                Password</a>
                                                        </li>
                                                        <li>
                                                            <a href="<?php echo e(route('store.email-preview', ['template'=>'welcome'])); ?>">Welcome
                                                                template</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="sub-dropdown-hover">
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li>
                                                            <a href="<?php echo e(route('store.invoice-preview', ['template'=>'invoice-1'])); ?>">Invoice 1</a>
                                                        </li>

                                                        <li>
                                                            <a href="<?php echo e(route('store.invoice-preview', ['template'=>'invoice-2'])); ?>">Invoice 2</a>
                                                        </li>

                                                        <li>
                                                            <a href="<?php echo e(route('store.invoice-preview', ['template'=>'invoice-3'])); ?>">Invoice 3</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'404'])); ?>">404</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'about-us'])); ?>">About Us</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'cart'])); ?>">Cart</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'contact-us'])); ?>">Contact</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'checkout'])); ?>">Checkout</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Coming Soon</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Compare</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'faq'])); ?>">Faq</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'order-success'])); ?>">Order
                                                        Success</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'order-tracking'])); ?>">Order
                                                        Tracking</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'otp'])); ?>">OTP</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'search'])); ?>">Search</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'user-dashboard'])); ?>">User
                                                        Dashboard</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.page', ['page'=>'wishlist'])); ?>">Wishlist</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Become a
                                                        Seller</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Seller
                                                        Dashboard</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Seller Detail</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Seller Detail
                                                        2</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Seller Grid</a>
                                                </li>
                                                <li>
                                                    <a class="dropdown-item" href="<?php echo e(route('store.home')); ?>">Seller Grid 2</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                        ...
                        <div>
                            <div class="home-contain rounded-0 p-0">
                                ...
                                <div class="home-detail home-big-space p-center-left home-overlay position-relative">
                                    <div class="container-fluid-lg">
                                        <div>
                                            <h6 class="ls-expanded theme-color text-uppercase"><?php echo e($cmsField($heroBanner, 'subtitle', 'Weekend Special offer')); ?></h6>
                                            <h1 class="heding-2"><?php echo e($cmsField($heroBanner, 'title', 'Premium Quality Dry Fruits')); ?></h1>
                                            <h2 class="content-2">Dryfruits shopping made Easy</h2>
                                            <h5 class="text-content"><?php echo e($cmsField($heroBanner, 'description', 'Fresh & Top Quality Dry Fruits are available here!')); ?></h5>
                                            <button
                                                class="btn theme-bg-color btn-md text-white fw-bold mt-md-4 mt-2 mend-auto"
                                                onclick="location.href = '<?php echo e($cmsField($heroBanner, 'button_url', route('store.page', ['page'=>'shop-left-sidebar']))); ?>';"><?php echo e($cmsField($heroBanner, 'button_text', 'Shop Now')); ?> <i class="fa-solid fa-arrow-right icon"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="bank-section overflow-hidden">
        <div class="container-fluid-lg">
            <div class="title">
                <h2><?php echo e($cmsSectionTitle('bank_wallet_offers', 'Bank & Wallet Offers')); ?></h2>
            </div>
                        ...
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="<?php echo e(asset('fastkart-store/images/grocery/bank/name/1.png')); ?>" class="img-fluid" alt="">
                                </div>
                                <div class="bank-name">
                                    <h2>GET 10% OFF</h2>
                            ...
                            <div class="bank-right w-100">
                                <img src="<?php echo e(asset('fastkart-store/images/grocery/bank/price/1.svg')); ?>" class="img-fluid" alt="">
                            </div>
                        </div>
                ...
                <div>
                    <div class="bank-offer">
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="<?php echo e(asset('fastkart-store/images/grocery/bank/name/2.png')); ?>" class="img-fluid" alt="">
                                </div>
                                <div class="bank-name">
                            ...
                            <div class="bank-right w-100">
                                <img src="<?php echo e(asset('fastkart-store/images/grocery/bank/price/2.svg')); ?>" class="img-fluid" alt="">
                            </div>
                        </div>
                ...
                <div>
                    <div class="bank-offer">
                        <div class="bank-header">
                            <div class="bank-left w-100">
                                <div class="bank-image">
                                    <img src="<?php echo e(asset('fastkart-store/images/grocery/bank/name/3.png')); ?>" class="img-fluid" alt="">
                                </div>
                                <div class="bank-name">
                            ...
                            <div class="bank-right w-100">
                                <img src="<?php echo e(asset('fastkart-store/images/grocery/bank/price/3.svg')); ?>" class="img-fluid" alt="">
                            </div>
                        </div>
    ...
    <section class="product-section product-section-3">
        <div class="container-fluid-lg">
            <div class="title">
                <h2><?php echo e($cmsSectionTitle('top_selling_items', 'Top Selling Items')); ?></h2>
            </div>
                            ...
                            <div class="top-selling-slider product-arrow">
                                <div>
                                    <div class="product-image">
                                        <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                            <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/big.png')); ?>"
                    ...
                    <div class="slider-5_2 img-slider">
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/1.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                            ...
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/2.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/3.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                            ...
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/4.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/5.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                            ...
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/6.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/7.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/8.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                            ...
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/deal/9.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
        ...
        <div class="container-fluid-lg">
            <div class="row gy-lg-0 gy-3">
                <div class="col-lg-6">
                    <div class="banner-contain-3 hover-effect">
                        <div>
                            <img src="<?php echo e(asset('fastkart-store/images/grocery/banner/6.jpg')); ?>" class="bg-img blur-up lazyload" alt="">
                            <div
                ...
                <div class="col-lg-6">
                    <div class="banner-contain-3 hover-effect">
                        <img src="<?php echo e(asset('fastkart-store/images/grocery/banner/7.jpg')); ?>" class="bg-img blur-up lazyload" alt="">
                        <div
                            class="banner-detail banner-detail-2 text-dark p-center-left w-75 banner-p-sm position-relative mend-auto">
                            <div>
    ...
    <section class="product-section">
        <div class="container-fluid-lg">
            <div class="title">
                <h2><?php echo e($cmsSectionTitle('drinks', 'Drinks')); ?></h2>
            </div>
                    ...
                    <div class="slider-7_1 arrow-slider img-slider">
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/1.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/2.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/3.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/4.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/5.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/6.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/7.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/drink/8.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
    ...
    <section class="product-section">
        <div class="container-fluid-lg">
            <div class="title">
                <h2><?php echo e($cmsSectionTitle('grocery_staples', 'Grocery & Staples')); ?></h2>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="slider-7_1 arrow-slider img-slider">
                        <div>
                            <div class="product-box-4 wow fadeInUp">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/1.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.05s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/2.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/3.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.15s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/4.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/5.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.25s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/6.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/7.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
                        ...
                        <div>
                            <div class="product-box-4 wow fadeInUp" data-wow-delay="0.35s">
                                <div class="product-image product-image-2">
                                    <a href="<?php echo e(route('store.page', ['page'=>'product-left-thumbnail'])); ?>">
                                        <img src="<?php echo e(asset('fastkart-store/images/grocery/product/grocery/8.png')); ?>"
                                            class="img-fluid blur-up lazyload" alt="">
                                    </a>
            ...
            <div class="row gy-lg-0 gy-3">
                <div class="col-lg-8">
                    <div class="banner-contain-3 h-100 pt-sm-5 hover-effect">
                        <img src="<?php echo e(asset('fastkart-store/images/grocery/banner/8.png')); ?>" class="bg-img blur-up lazyload" alt="">
                        <div
                ...
                <div class="col-lg-4">
                    <div class="banner-contain-3 pt-lg-4 h-100 hover-effect">
                        <a href="javascript:void(0)">
                            <img src="<?php echo e(asset('fastkart-store/images/grocery/banner/9.jpg')); ?>"
            ...
            <div class="slider-3-blog arrow-slider slick-height">
                <div>
                    <div class=" blog-box ratio_45">
                        <div class="blog-box-image">
                            <a href="<?php echo e(route('store.home')); ?>">
                                <img src="<?php echo e(asset('fastkart-store/images/grocery/blog/1.jpg')); ?>" class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_45">
                        <div class="blog-box-image">
                            <a href="<?php echo e(route('store.home')); ?>">
                                <img src="<?php echo e(asset('fastkart-store/images/grocery/blog/2.jpg')); ?>" class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_45">
                        <div class="blog-box-image">
                            <a href="<?php echo e(route('store.home')); ?>">
                                <img src="<?php echo e(asset('fastkart-store/images/grocery/blog/3.jpg')); ?>" class="blur-up lazyload bg-img" alt="">
                            </a>
                        </div>
                ...
                <div class="row g-md-4 gy-sm-5">
                    ...
                    <div class="col-xxl-2 col-xl-4 col-sm-6">
                        ...
                        <ul class="footer-list footer-contact footer-list-light">
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'about-us'])); ?>" class="light-text">About Us</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'contact-us'])); ?>" class="light-text">Contact Us</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">Terms & Conditions</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">Careers</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">Latest Blog</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xxl-2 col-xl-4 col-sm-6">
                        ...
                        <ul class="footer-list footer-list-light footer-contact">
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'order-success'])); ?>" class="light-text">Your Order</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'user-dashboard'])); ?>" class="light-text">Your Account</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'order-tracking'])); ?>" class="light-text">Track Orders</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'wishlist'])); ?>" class="light-text">Your Wishlist</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.page', ['page'=>'faq'])); ?>" class="light-text">FAQs</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xxl-2 col-xl-4 col-sm-6">
                        ...
                        <ul class="footer-list footer-list-light footer-contact">
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">Fresh Vegetables</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">Hot Spice</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">Brand New Bags</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">New Bakery</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('store.home')); ?>" class="light-text">New Grocery</a>
                            </li>
                        </ul>
                    </div>
